...
import io.debezium.connector.maria.BinlogReader.BinlogPosition;
...
//            } else 
    ...
    private void switchToBufferFullMode() {
        ...
        // Position for TABLE_MAP is not stored by com.github.yomo.maria.binlog.BinaryLogClient.updateClientBinlogFilenameAndPosition(Event)
